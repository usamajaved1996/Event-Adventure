...
import MainImg from '../../../assets/images/sport.png';
import WebView from 'react-native-webview';

const SportDetail = ({ navigation }) => {
    ...
    return (
        <View style={styles.mainContainer}>
            ...
            <WebView
                style={styles.map}
                source={{ uri: 'https://singles.eventsandadventures.com/website/message.aspx?Handbook-Sports' }}
