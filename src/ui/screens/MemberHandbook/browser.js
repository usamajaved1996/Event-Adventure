...
import MainImg from '../../../assets/images/browser.png';
...
const Browser = ({ navigation }) => {
    ...
    return (
        <View style={styles.mainContainer}>
            <Header title={'Browser Best Practices'} />
            ...
            <WebView
                style={styles.map}
                source={{ uri: 'https://singles.eventsandadventures.com/website/message.aspx?Handbook-Browser' }}
