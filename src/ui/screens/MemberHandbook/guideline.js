...
import MainImg from '../../../assets/images/guide.png';
...
const GuideDetail = ({ navigation }) => {
    ...
    return (
        <View style={styles.mainContainer}>
            <Header title={'Guidelines and Policies'} />
            ...
            <WebView
                style={styles.map}
                source={{ uri: 'https://singles.eventsandadventures.com/website/message.aspx?Handbook-Guidelines' }}
