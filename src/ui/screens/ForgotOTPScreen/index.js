...
import { otpCode, forgotPassword } from '../../../slices/authSlice';
    ...
    const onSubmitOtp = async () => {
        if (validateFields()) {
            ...
            try {
                ...
                const response = await dispatch(otpCode({ userName, otp: otpCodeParse }));
                if (response.payload.statusCode == 200) {
                    toastMsg(response.payload.message);
                    navigation.navigate('Reset', { userName, otpCodeParse });
